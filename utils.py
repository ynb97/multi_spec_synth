...
def local_tts(input_text, language=None, output_file=None, model_name=None):
    ...
    try:
        ...
        tts.tts_to_file(
            text=input_text, 
            speaker_wav=os.path.join("data", "uploads", "uploaded_voice_sample.mp3"), 
            language=language, 
...
if __name__ == "__main__":
    ...
    # text = "Dies ist ein Beispieltext für Google Cloud Text-to-Speech"
    # language = "German"
    # filename = "output.mp3"
    ...
    for key, value in [("English", "en")]:
        ...
        local_tts(
            google_translate("The girl at the booth sold fifty bonds.", key), 
            key,
            f"output10_{value}.wav"
        )
